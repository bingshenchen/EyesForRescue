...
def setup_menubar(root, extract_frames, generate_labels, train_model, open_video_file, start_camera, analyze_report):
    ...
    # analysis_menu.add_command(labels="Alert Test", command=alert_test)
